...
summary: Aprenda a implementar Postgres desde un gráfico de Helm. Después de implementar Postgres en su clúster, puede registrar la aplicación con Astra Control. 
---
